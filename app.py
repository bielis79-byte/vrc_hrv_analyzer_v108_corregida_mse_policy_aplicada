...
st.set_page_config(page_title="VRC / HRV RRi Analyzer Pro v10.8 corregida", layout="wide")
...
def entropy_diagnostic_figure(diag_df):
    ...
    fig.update_layout(
        title="Diagnóstico SampEn / MSE: clásico vs pseudoconteos",
...
def _single_record_report(record_name, metrics_df, windows, rr=None):
    ...
    if any(c in metrics_df.columns for c in MSE_COLUMNS):
        ...
        if rr is not None:
            ...
            lines.append("")
            lines.append("| Fase | Escala | N | r ms | B | A | A/B | Clásico | A0=0.5 | A0=1.0 | Estado |")
            lines.append("|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|")
...
st.title("VRC / HRV RRi Analyzer Pro v10.8 corregida")
...
def free_pairs_hvg_metrics_table(long_df, pairs):
    ...
    st.caption(
        "Muestra por escala MSE: N, SD, r=0.2×SD, B/A y los tres modos: clásico, A0=0.5 y A0=1.0. "
